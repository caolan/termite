define(['exports', './call-dispatcher'], function (exports, calld) {
    ...
    exports.spawn = function (manager, call_dispatcher, pid, module, pageonly) {
        pid = pid || exports.createPid(manager);
        if (manager.processes[pid]) {
            throw new Error('Process already exists with pid: ' + pid);
        }
        var p = {
            module: module,
            ready: false,
    ...
    exports.create = function (requirejs, n) {
        ...
        m.spawn = function (pid, module, pageonly) {
            return exports.spawn(m, d, pid, module, pageonly);
        };
        return m;
    };
